...
async function ExibirTropas(lobbyId) {
  ...
  const coordenadasTextos = [
    ...
    { x: 98.32, y: 88.36-20 },
    { x: 176.02, y: 86.16-20 },
    { x: 180.07, y: 107.85-20 },
    { x: 137.36, y: 103.34-20 },
    { x: 162.97, y: 103.30-20 },
    { x: 51.08, y: 67.95-20 },
    { x: 53.52, y: 85.85-20 },
    { x: 76.71, y: 42.48-20 },
    { x: 97.05, y: 54.27-20 },
    { x: 122.93, y: 107.77-20 },
    { x: 107.77, y: 113.83-20 },
    { x: 122.30, y: 132.08-20 },
    { x: 133.97, y: 128.68-20 },
    { x: 125.50, y: 149.48-20 },
    { x: 188.31, y: 158.26-20 },
    { x: 208.02, y: 138.14-20 },
    { x: 209.88, y: 76.33-20 },
    { x: 173.73, y: 134.79-20 },
    { x: 189.87, y: 124.29-20 },
    { x: 145.07, y: 154.65-20 },
    { x: 87.52, y: 69.71-20 }
