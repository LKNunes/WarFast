...
*/
    ...
    const donoterritorios = [
      ...
      { idterritorio: 3, dono: 0 },
      { idterritorio: 4, dono: 0 },
      { idterritorio: 5, dono: 0 },
      { idterritorio: 6, dono: 0 },
      { idterritorio: 7, dono: 0 },
      { idterritorio: 8, dono: 0 },
      { idterritorio: 9, dono: 0 },
      { idterritorio: 10, dono: 0 },
      { idterritorio: 11, dono: 0 },
      { idterritorio: 12, dono: 0 },
      { idterritorio: 13, dono: 0 },
      { idterritorio: 14, dono: 0 },
      { idterritorio: 15, dono: 0 },
      { idterritorio: 16, dono: 0 },
      { idterritorio: 17, dono: 0 },
      { idterritorio: 18, dono: 0 },
      { idterritorio: 19, dono: 0 },
      { idterritorio: 20, dono: 0 },
      { idterritorio: 21, dono: 0 },
      { idterritorio: 22, dono: 0 },
      { idterritorio: 23, dono: 0 },
      { idterritorio: 24, dono: 0 },
      { idterritorio: 25, dono: 0 },
      { idterritorio: 26, dono: 0 },
      { idterritorio: 27, dono: 0 },
      { idterritorio: 28, dono: 0 },
      { idterritorio: 29, dono: 0 },
      { idterritorio: 30, dono: 0 },
      { idterritorio: 31, dono: 0 },
      { idterritorio: 32, dono: 0 },
      { idterritorio: 33, dono: 0 },
      { idterritorio: 34, dono: 0 },
      { idterritorio: 35, dono: 0 },
      { idterritorio: 36, dono: 0 },
      { idterritorio: 37, dono: 0 },
      { idterritorio: 38, dono: 0 },
      { idterritorio: 39, dono: 0 },
      { idterritorio: 40, dono: 0 },
      { idterritorio: 41, dono: 0 },
      { idterritorio: 42, dono: 0 }
    ];
    ...
    //  console.log(`Número ${i + 1} (Número ${distribuicao[jogador][Math.floor(i / 8)]}) está com o Jogador ${jogador + 1}`);
      ...
      donoterritorios[i].idterritorio = i+1;
      donoterritorios[i].dono = PartidaDados.playerSlots[jogador].id;
      console.log("Territorio:"+donoterritorios[i].idterritorio+" Dono:"+donoterritorios[i].dono +""+paths[i].id);
