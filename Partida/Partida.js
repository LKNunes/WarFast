...
document.getElementById('nomeJogador').textContent =  PartidaDados.playerSlots[1].cor;
document.getElementById('corJogador').textContent = PartidaDados.playerSlots[1].id;
